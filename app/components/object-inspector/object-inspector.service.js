      ...
      function(
        ...
        function ObjectInspectorService() {
          ...
          this.isRobot = function() {
            return (
              this.selectedObject && sceneInfo.isRobot(this.selectedObject)
            );
          };
          ...
          this.setRobotMode = function(robotMode) {
            if (this.robotMode !== robotMode) {
              ...
              if (this.robotMode) {
                ...
                userNavigationService.lookatControls.setDistance(
                  userNavigationService.lookatControls.minDistance + 1.3
                );
          ...
          this.update = function() {
            ...
            that.isARobot = sceneInfo.isRobot(that.selectedObject);
